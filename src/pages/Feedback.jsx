...
export default function Feedback() {
  ...
  // Função que será chamada ao confirmar a exclusão no modal
  function confirmarRemocao() {
    if (collaboratorToRemove) {
      setMembros((prev) =>
        prev.filter((m) => m.id !== collaboratorToRemove.id),
      );
  ...
  return (
    <>
          ...
          <Card className="border-t-2 border-t-primary">
            <CardContent className="p-5">
              ...
              <p className="text-4xl font-bold text-primary">
                {RESUMO_CARDS.mediaGeral}
              </p>
              <p className="text-xs text-muted-foreground mt-1">
                {RESUMO_CARDS.comparacao}
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-t-2 border-t-destructive">
            <CardContent className="p-5">
              ...
              <p className="text-xl font-semibold text-destructive">
                {RESUMO_CARDS.deficit.nome}
              </p>
              <p className="text-xs text-muted-foreground mt-1">
                média {RESUMO_CARDS.deficit.media}
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-5">
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <p className="text-sm font-medium text-foreground">
                  {RESUMO_CARDS.destaque.nome}
                </p>
              </div>
              <p className="text-4xl font-bold text-chart-5">
                {RESUMO_CARDS.destaque.nota}
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-t-2 border-t-chart-4">
            <CardContent className="p-5">
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <p className="text-sm font-medium text-foreground">
                  {RESUMO_CARDS.atencao.nome}
                </p>
              </div>
              <p className="text-4xl font-bold text-chart-4">
                {RESUMO_CARDS.atencao.nota}
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <Card className="border-chart-4/30">
              <CardContent className="p-5">
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  Recomenda-se sessões de feedback individual e workshops
                  focados nesta competência.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary/30">
              <CardContent className="p-5">
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  Utilize esses colaboradores como referência em mentorias
                  internas.
                </p>
              </CardContent>
            </Card>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <Badge
                    ...
                    className={cn(
                      ...
                      getNotaVariant(membro.media),
                    )}
                  >
                    {membro.media}
                  </Badge>

                  {/* Alteração no onClick para abrir o Modal */}
                  <Button
                    variant="ghost"
                    size="icon-sm"
                    onClick={() => {
                      setCollaboratorToRemove(membro);
      ...
      <ConfirmDialog
        ...
        description={`Tem certeza que deseja remover ${collaboratorToRemove?.nome}? Esta ação afetará as métricas do ciclo atual.`}
